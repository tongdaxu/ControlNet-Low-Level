...
from diffusers.schedulers import EulerAncestralDiscreteScheduler, DDPMScheduler
...
if __name__ == "__main__":
    ...
    for i, x in enumerate(dataloader):
        ...
        image.save("test_sd_dps.png")

        image = pipe.run_multi_dps(f=f,
                                   y=y,
                                   scale=2.4,
                                   prompt="",
                                   height=512,
