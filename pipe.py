...
class StableDiffusionInverse(StableDiffusionPipeline):
    ...
    def run_multi_dps(
        ...
        **kwargs,
        ...
        image0, _, latents1 = self.run_dps(
            f=f, y=y, scale=scale, prompt=prompt, height=height, width=width,
            num_inference_steps=num_inference_steps,
            latents_start=None,
            timesteps_start=0,
            timesteps=timesteps, sigmas=sigmas, guidance_scale=guidance_scale,
            negative_prompt=negative_prompt, num_images_per_prompt=num_images_per_prompt,
        ...
        image0[0].save("test_sd2_r0.png")

        timesteps_start1 = int(num_inference_steps * 0.5)
        image1, _, latents2 = self.run_dps(
            f=f, y=y, scale=scale, prompt=prompt, height=height, width=width,
            num_inference_steps=num_inference_steps,
            latents_start=latents1,
            timesteps_start=timesteps_start1,
            timesteps=timesteps, sigmas=sigmas, guidance_scale=guidance_scale,
            negative_prompt=negative_prompt, num_images_per_prompt=num_images_per_prompt,
            eta=eta, generator=generator, latents=latents,
            prompt_embeds=prompt_embeds,
        ...
        image1[0].save("test_sd2_r1.png")

        timesteps_start2 = int(num_inference_steps * 0.75)
        image2, _, latents3 = self.run_dps(
            f=f, y=y, scale=scale, prompt=prompt, height=height, width=width,
            num_inference_steps=num_inference_steps,
            latents_start=latents1,
            timesteps_start=timesteps_start2,
            timesteps=timesteps, sigmas=sigmas, guidance_scale=guidance_scale,
            negative_prompt=negative_prompt, num_images_per_prompt=num_images_per_prompt,
            eta=eta, generator=generator, latents=latents,
            prompt_embeds=prompt_embeds,
        ...
        image2[0].save("test_sd2_r2.png")
        
        return (image1, None, latents)
